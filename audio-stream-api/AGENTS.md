...
La carpeta `docs/specs/` contiene las especificaciones de funcionalidades del proyecto organizadas por módulo (frontend, web-admin, etc.). Cada archivo MD describe los requisitos, casos de uso y comportamiento esperado de una funcionalidad específica. Esta carpeta sirve como fuente de verdad para el desarrollo y debe consultarse antes de implementar nuevas features.

### Información sobre decisiones de arquitectura
docs/00-architecture-decisions.md